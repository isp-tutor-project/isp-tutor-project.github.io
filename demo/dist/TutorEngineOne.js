            ...
            WebLogger = class WebLogger {
                ...
                getTutorState(tutorID) {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        yield db.getUserData().then((data) => {
                            // ignore bogus rqted data getUserData() provides 
                            // if (data) {
                            //     // console.error(data);
                            //     // if (data.rqted && "object" === typeof(data.rqted)) {
                            //     //     // expecting JSON format
                            //     //     jsonData = JSON.stringify(data.rqted);
                            //     // } 
                            //     // else {
                            //     //     jsonData = undefined;
                            //     // }
                            this.currTutorNdx = data.currTutorNdx;
                            // } else {
                ...
                tutorComplete() {
                    ...
                    db.saveValue("currTutorNdx", this.currTutorNdx)
                    .then(() => db.saveValue("rqted", this.currTutorState))
                    .then(function () {
